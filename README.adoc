...
=== [underline]#EXERCICE# 1: En partant de l’activity realise hier, enlever l’image et ajouter un bouton qui permet de recuperer la liste des informations saisies et les afficher dans le LOGCAT.
